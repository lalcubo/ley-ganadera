      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #f9fafb; padding: 30px; border: 1px solid #e5e7eb; border-radius: 0 0 12px 12px;">
            ...
            <div style="background: #eff6ff; border-left: 4px solid #2563eb; padding: 15px; margin: 20px 0; border-radius: 6px;">
            ...
            <p style="color: #374151; font-size: 16px; line-height: 1.6; margin-top: 25px;">
              Atentamente,<br>
              <strong style="color: #1e3a8a;">Comité Organizador</strong><br>
